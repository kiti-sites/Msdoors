print("--// <THE HOTE> | UPDATE EM BREVEL \\--                                                                              ")
print("--[[														    ")
print("                                                                                                                     ")
print("     ______  _______            ______       _____           _____            _____         _____            ______  ")
print("    |      \/       \       ___|\     \  ___|\    \     ____|\    \      ____|\    \    ___|\    \       ___|\     \ ")
print("   /          /\     \     |    |\     \|    |\    \   /     /\    \    /     /\    \  |    |\    \     |    |\     \")
print("  /     /\   / /\     |    |    |/____/||    | |    | /     /  \    \  /     /  \    \ |    | |    |    |    |/____/|")
print(" /     /\ \_/ / /    /| ___|    \|   | ||    | |    ||     |    |    ||     |    |    ||    |/____/  ___|    \|   | |")
print("|     |  \|_|/ /    / ||    \    \___|/ |    | |    ||     |    |    ||     |    |    ||    |\    \ |    \    \___|/ ")
print("|     |       |    |  ||    |\     \    |    | |    ||\     \  /    /||\     \  /    /||    | |    ||    |\     \    ")
print("|\____\       |____|  /|\ ___\|_____|   |____|/____/|| \_____\/____/ || \_____\/____/ ||____| |____||\ ___\|_____|   ")
print("| |    |      |    | / | |    |     |   |    /    | | \ |    ||    | / \ |    ||    | /|    | |    || |    |     |   ")
print(" \|____|      |____|/   \|____|_____|   |____|____|/   \|____||____|/   \|____||____|/ |____| |____| \|____|_____|   ")
print("    \(          )/         \(    )/       \(    )/        \(    )/         \(    )/      \(     )/      \(    )/     ")
print("     '          '           '    '         '    '          '    '           '    '        '     '        '    '      ")
print("                                                                                                                     ")
print("                                        Por Rhyan57 💜								    ")
