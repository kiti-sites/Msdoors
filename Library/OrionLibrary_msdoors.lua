...
if not Success then
	warn("\n[Msdoors] Orion Library - Falha ao carregar Feather Icons. Código de erro: " .. Response .. "\n")
end	
...
function OrionLib:MakeNotification(NotificationConfig)
	spawn(function()
		...
		NotificationConfig.Image = NotificationConfig.Image or "rbxassetid://95869322194132"
...
function OrionLib:MakeWindow(WindowConfig)
	...
	WindowConfig.Name = WindowConfig.Name or "Msdoors Lib"
	...
	WindowConfig.IntroToggleIcon = WindowConfig.IntroToggleIcon or "rbxassetid://95869322194132"
	WindowConfig.IntroText = WindowConfig.IntroText or "Msdoors Lib"
	WindowConfig.CloseCallback = WindowConfig.CloseCallback or function() end
	WindowConfig.ShowIcon = WindowConfig.ShowIcon or false
	WindowConfig.Icon = WindowConfig.Icon or "rbxassetid://95869322194132"
	WindowConfig.IntroIcon = WindowConfig.IntroIcon or "rbxassetid://95869322194132"
	...
	local CloseBtn = SetChildren(SetProps(MakeElement("Button"), {
		...
		AddThemeObject(SetProps(MakeElement("Image", "rbxassetid://95869322194132"), {
    ...
    local MobileReopenButton = SetChildren(SetProps(MakeElement("Button"), {
		...
		AddThemeObject(SetProps(MakeElement("Image", WindowConfig.IntroToggleIcon or "http://www.roblox.com/asset/?id=95869322194132"), {
	...
	AddConnection(CloseBtn.MouseButton1Up, function()
		...
		OrionLib:MakeNotification({
			...
			Content = "Toque no Controle Esquerdo ou no botão para reabrir a interface",
			Time = 5
		})
...
function OrionLib:MakeNotifi(Configs)
  ...
  local text = Configs.Text or "Conteúdo da notificação... o que ela dirá??"
